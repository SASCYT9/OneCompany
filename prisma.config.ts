...
// Explicit shell/CI variables must always win. This is especially important for
// production migration commands, which should never be redirected to a local DB.
