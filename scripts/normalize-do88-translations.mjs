...
function applyTextRules(value, locale) {
  ...
  if (locale === 'en') {
    ...
    next = next
      ...
      .replace(/масляний радіатор двигуна\s+Racing\s+для/gi, 'гоночний масляний радіатор двигуна для')
      .replace(/масляний радіатор двигуна\s+Racing/gi, 'гоночний масляний радіатор двигуна')
      .replace(/масляний радіатор DCT\s+Racing/gi, 'гоночний масляний радіатор DCT')
      .replace(/радіатор гідропідсилювача\s+Racing/gi, 'гоночний радіатор гідропідсилювача')
