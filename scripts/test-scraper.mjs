...
async function main() {
  const url = 'https://www.brabus.com/de-de/cars/tuning/auf-basis-mercedes/uebersicht/artikel/p/cls-klasse/c-257/amg-cls-53/f13-257-bp.html';
  ...
  $('[data-tracking]').each((i, el) => {
    try {
      ...
      // Look for the main product ID "F13-257-BP" inside the products array
