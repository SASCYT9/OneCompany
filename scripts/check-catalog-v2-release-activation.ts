...
const decision = assertShopCatalogReleaseActivation({
  nodeEnv: process.argv.includes("--production-build") ? "production" : process.env.NODE_ENV,
  readerMode: process.env.SHOP_CATALOG_V2_READER_MODE,
  vehicleReaderMode: process.env.SHOP_CATALOG_V2_VEHICLE_READER_MODE,
