...
const JSON_PATH = path.resolve(
  process.env.DO88_SOURCE_JSON || "archive/data-dumps/do88-products-v4.json"
);
const SQL_PATH = path.resolve(process.env.DO88_SQL_OUTPUT || ".tmp/do88/update_do88_desc.sql");
