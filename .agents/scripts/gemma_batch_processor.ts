...
// Legacy demonstration only. It currently processes mock rows rather than the
// supplied CSV path and must not be used as a catalog import/translation pipeline.
