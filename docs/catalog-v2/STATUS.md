...
| C2-P2-002 | Mutation coordinator and outbox publisher         | In progress | Core admin writers and central CSV create/update green; supplier/brand sync writers pending |
