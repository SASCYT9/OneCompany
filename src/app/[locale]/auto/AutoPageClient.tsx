...
const BRAND_DISPLAY_NAMES: Record<string, string> = {
  ...
  "S3 Power Sports": "S3",
  SuperATV: "SuperATV",
  "Assault Industries": "Assault Industries",
  ...
  "MST Performance": "MST",
  "AMS / Alpha Performance": "ALPHA",
  "Whipple Superchargers": "WHIPPLE",
  "VF Engineering": "VF ENG.",
  "JXB Performance": "JXB",
  "Cobb tuning": "COBB",
  "AIM Sportline": "AIM",
  "MCA Suspension": "MCA",
  "ARE dry sump": "ARE",
  "Wagner Tuning": "WAGNER",
  "Link ECU": "LINK",
  "Pure Turbos": "PURE",
  "ESS Tuning": "ESS",
  "ARMA Speed": "ARMASPEED",
  "BMC filters": "BMC",
...
const LEGENDARY_BRAND_CONFIG: Record<
  string,
  {
    flag: string;
    country: string;
...
export default function AutomotivePage() {
  ...
  const findBrandByName = useCallback(
    (name: string) => {
      return (
        topBrands.find((b) => b.name === name) || allAutomotiveBrands.find((b) => b.name === name)
      );
    },
    [topBrands]
  );
          ...
          <section className="relative py-24 sm:py-32 md:py-40 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="mb-16 sm:mb-20 md:mb-28 text-center">
                ...
                >
                  {locale === "ua"
                    ? "Бренди, що формують індустрію"
                    : "Brands that define the industry"}
                </m.p>
              </div>
                  ...
                  <div className="relative h-full p-6 sm:p-8 flex flex-col min-h-[180px]">
                    <div className="flex-1 flex items-center justify-center py-4">
                      <div className="relative w-full max-w-[160px] h-16 sm:h-20">
                        <Image
                          src={getBrandLogo("HRE Wheels")}
                          alt="HRE Wheels Україна - ковані диски тюнінг Київ, купити HRE OneCompany"
                          fill
                  ...
                  <div className="relative h-full p-6 sm:p-8 flex flex-col min-h-[220px]">
                    <div className="flex-1 flex items-center justify-center py-4">
                      <div className="relative w-full max-w-[180px] h-14 sm:h-18">
                        <Image
                          src={getBrandLogo("Urban Automotive")}
                          alt="Urban Automotive Україна - карбонові обвіси тюнінг Київ, купити Urban OneCompany"
                          fill
                  ...
                  <div className="relative h-full p-6 sm:p-8 flex flex-col min-h-[220px]">
                    <div className="flex-1 flex items-center justify-center py-4">
                      <div className="relative w-full max-w-[200px] h-16 sm:h-20">
                        <Image
                          src={getBrandLogo("Eventuri")}
                          alt="Eventuri Україна - впускні системи карбон тюнінг Київ, купити Eventuri OneCompany"
                          fill
                          className="object-contain transition-all duration-500 group-hover:opacity-100 group-hover:scale-110"
                          unoptimized
                        />
                  ...
                  <div className="relative h-full p-6 sm:p-8 flex flex-col min-h-[220px]">
                    <div className="flex-1 flex items-center justify-center py-4">
                      <div className="relative w-full max-w-[160px] h-20 sm:h-24">
                        <Image
                          src={getBrandLogo("KW Suspension")}
                  ...
                  <div className="relative p-6 sm:p-8 lg:p-10">
                    ...
                    <div className="relative overflow-hidden">
                      ...
                      <div className="flex gap-6 mb-4 animate-scroll-left">
                        {[
                          ...allAutomotiveBrands.slice(0, 20),
                          ...allAutomotiveBrands.slice(0, 20),
                        ].map((brand, idx) => (
                          <button
                      ...
                      <div className="flex gap-6 animate-scroll-right">
                        {[
                          ...allAutomotiveBrands.slice(20, 40),
                          ...allAutomotiveBrands.slice(20, 40),
                        ].map((brand, idx) => (
                          <button
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <button
                  onClick={() => {
                    ...
                    setTimeout(() => {
                      document
                        .getElementById("brand-list-container")
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="relative mt-4 h-24 w-full sm:mt-6 sm:h-32">
                              <div
                                className="relative w-full h-full px-2"
