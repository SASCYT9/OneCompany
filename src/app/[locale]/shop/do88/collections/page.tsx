  ...
  return (
    <>
      ...
      <div className="w-full px-4 md:px-8 mb-4 mt-2 max-w-[1500px] mx-auto">
        <Suspense fallback={<div className="h-16 bg-white/5 rounded-2xl animate-pulse max-w-5xl mx-auto" />}>
          <Do88VehicleFilter locale={resolvedLocale} compact={true} />
        </Suspense>
      </div>
      <Suspense fallback={<div className="flex justify-center items-center min-h-[50vh]"><div className="w-8 h-8 rounded-full border-4 border-cyan-500 border-t-transparent animate-spin"/></div>}>
