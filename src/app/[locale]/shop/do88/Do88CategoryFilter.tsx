...
export default function Do88CategoryFilter({ locale, currentHandle, variant = 'horizontal' }: Do88CategoryFilterProps) {
  ...
  if (variant === 'sidebar') {
    return (
      <div className="flex flex-col gap-1 w-full do88-animate-up" style={{ animationDelay: '0.2s' }}>
        <h3 className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-3 ml-2">
  ...
  return (
    <div className="w-full flex items-center overflow-x-auto gap-3 pb-2 pt-2 do88-animate-up" style={{ animationDelay: '0.2s' }}>
      {categories.map((cat) => {
        const isActive = currentHandle === cat.handle;
        return (
          <Link
