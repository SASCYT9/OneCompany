      ...
      <div className="max-w-[1700px] mx-auto px-6 md:px-12 lg:px-16 pb-20 relative z-20">
        <div className="flex flex-col gap-10">
          ...
          <div className="relative z-30 mb-8 max-w-5xl mx-auto w-full">
            ...
            {/* CONTROLS ROW — 4 columns: Make / Category / Search / Sort */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {/* MAKE DROPDOWN */}
              <div className="relative border border-white/20 hover:border-[#c29d59]/50 transition-colors">
                <select
                  value={activeMake}
                  onChange={(e) => setActiveMake(e.target.value)}
                  className="appearance-none w-full bg-[#0a0a0c] text-white text-[11px] uppercase tracking-[0.1em] font-light px-5 py-4 pr-10 outline-none cursor-pointer rounded-none"
                >
                  <option value="all" className="bg-[#0a0a0c] text-zinc-500 font-light">{isUa ? "Виберіть Марку" : "Select Make"}</option>
              ...
              <div className="relative border border-white/20 hover:border-[#c29d59]/50 transition-colors">
                <select
                  ...
                  className="appearance-none w-full bg-[#0a0a0c] text-white text-[11px] uppercase tracking-[0.1em] font-light px-5 py-4 pr-10 outline-none cursor-pointer rounded-none"
                >
                  <option value="all" className="bg-[#0a0a0c] text-zinc-500 font-light">{isUa ? "Усі Лінійки" : "All Lines"}</option>
              ...
              <div className="relative border border-white/20 hover:border-[#c29d59]/50 transition-colors">
                ...
                <input
                  ...
                  className="w-full bg-[#0a0a0c] text-white text-[11px] tracking-[0.1em] font-light px-12 py-4 outline-none placeholder-zinc-500 rounded-none cursor-text"
                />
                {searchQuery && (
                  <button
              ...
              <div className="relative border border-white/20 hover:border-[#c29d59]/50 transition-colors">
                ...
                <select
                  ...
                  className="appearance-none w-full bg-[#0a0a0c] text-white text-[11px] uppercase tracking-[0.1em] font-light pl-12 py-4 pr-10 outline-none cursor-pointer rounded-none"
                >
                  <option value="default" className="bg-[#0a0a0c] text-white">{isUa ? "За замовчуванням" : "Default Sort"}</option>
                  <option value="price_desc" className="bg-[#0a0a0c] text-white">{isUa ? "Спочатку дорожчі" : "Price: High to Low"}</option>
                  <option value="price_asc" className="bg-[#0a0a0c] text-white">{isUa ? "Спочатку дешевші" : "Price: Low to High"}</option>
                </select>
                <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center px-4 text-zinc-500">
                  <ChevronDown size={14} strokeWidth={1.5} />
                </div>
            ...
            <div className="flex items-center justify-between mt-6">
              <p className="text-zinc-500 text-[10px] sm:text-xs font-light tracking-widest">
                ...
                {(activeMake !== "all" || activeCategory !== "all" || searchQuery) && (
                  <> · <button
