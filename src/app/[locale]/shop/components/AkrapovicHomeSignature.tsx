...
const getModelImage = (brandKey: string, modelKey: string, fallbackBrandImage: string): string => {
  ...
  if (brandKey === "Ducati") {
    ...
    if (modelKey.includes("Streetfighter V4"))
      return "/images/shop/akrapovic/ducati-streetfighter-v4.webp?v=3";
    ...
    if (modelKey.includes("Diavel V4")) return "/images/shop/akrapovic/ducati-diavel-v4.webp?v=4";
  }
                        ...
                        <div className="ak-brand-row-card__header">
                          <div className="ak-brand-row-card__header-left">
                            <div className="ak-brand-row-card__title-row">
                              <BrandLogo
                                brandKey={b.key}
                                className="ak-brand-row-card__logo-icon"
                              />
                            ...
                            if (m.generations) {
                              return (
                                ...
                                >
                                  ...
                                  {m.years && (
                                    <span className="ak-model-grid-card__year-badge">
                                      {m.years}
                                    </span>
                                  )}
