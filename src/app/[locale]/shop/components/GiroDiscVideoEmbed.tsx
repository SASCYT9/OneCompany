 ...
 * Used as ambient cinematic background — no controls, autoplay, muted, looped.
 */
export default function GiroDiscVideoEmbed({ youtubeId, className = '' }: Props) {
  ...
  return (
    <div ref={ref} className={`gd-video-embed ${className}`}>
      {isVisible && (
        <iframe
