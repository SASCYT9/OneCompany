  ...
  return (
    ...
    >
      <div className="urban-product-grid__inner">
        ...
        >
          <div>
            <p className="urban-product-grid__eyebrow">{brand || "Urban Automotive"}</p>
        ...
        {products.length > 0 ? (
          ...
          >
            {products.map((product) => {
              ...
              const productCollectionHandle =
                getUrbanCollectionHandleForProduct(product) ?? collectionHandle;
              ...
              return (
                ...
                >
                  ...
                  <div className="urban-product-grid__body backdrop-blur-md bg-foreground/8 dark:bg-white/5 border border-foreground/15 dark:border-white/10 rounded-b-xl">
                    <p className="urban-product-grid__brand">{product.brand}</p>
                    <h3 className="urban-product-grid__name">{productTitle}</h3>
          ...
          >
            ...
            <Link
              href={`/${locale}/contact`}
              className="urban-product-grid__empty-cta hover:bg-white hover:text-black transition-colors duration-500"
            >
