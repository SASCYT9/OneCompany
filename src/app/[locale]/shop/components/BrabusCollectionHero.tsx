  ...
  return (
    <>
      <style jsx global>{`
        ...
        .bch-hero__overlay {
          position: absolute; inset: 0;
          background: linear-gradient(to top, rgba(0,0,0,.92) 0%, rgba(0,0,0,.3) 50%, rgba(0,0,0,.15) 100%);
        }
        .bch-hero__accent {
        ...
        .bch-hero__back {
          ...
          color: var(--bch-muted); text-decoration: none;
          transition: color .3s; margin-bottom: 2rem; display: inline-block;
        }
        .bch-hero__back:hover { color: #fff; }
        .bch-hero__eyebrow {
          font-size: .6rem; font-weight: 500; text-transform: uppercase;
          letter-spacing: .25em; color: var(--bch-red);
          margin: 0 0 .75rem;
        }
        .bch-hero__title {
        ...
        .bch-hero__subtitle {
          font-size: .8rem; font-weight: 300; color: var(--bch-muted);
          letter-spacing: .02em; line-height: 1.7;
          max-width: 520px; margin: 0 0 2rem;
        }
        .bch-hero__desc {
          font-size: .78rem; font-weight: 300; color: rgba(255,255,255,.5);
          line-height: 1.8; max-width: 500px; margin: 0 0 2rem;
        }
        .bch-hero__meta {
        ...
        .bch-hero__count {
          ...
          font-size: .6rem; font-weight: 500; text-transform: uppercase;
          letter-spacing: .15em; color: var(--bch-muted);
        }
        .bch-hero__count-num {
          font-size: 1.1rem; font-weight: 200; color: #fff;
        }
        ...
        .bch-spec:last-child { border-right: none; }
        .bch-spec__val {
        ...
        .bch-spec__label {
          ...
          color: var(--bch-muted); margin-top: .3rem;
        }

        @media (max-width: 768px) {
          .bch-hero__content { padding: 3rem 1.5rem; }
          .bch-specs { flex-direction: column; }
          .bch-spec { border-right: none; border-bottom: 1px solid var(--bch-faint); padding: 1rem; }
          .bch-spec:last-child { border-bottom: none; }
        }
      `}</style>
      ...
      <div className="bch">
        <section className="bch-hero">
          <div className="bch-hero__media">
            ...
            <img className="bch-hero__img" src={config.heroImage} alt={config.title} loading="eager" />
          </div>
          ...
          <div className="bch-hero__content">
            ...
            <h1 className="bch-hero__title">
              {L(isUa, config.title, config.titleUk)}
            </h1>
            <p className="bch-hero__subtitle">
              {L(isUa, config.subtitle, config.subtitleUk)}
            </p>
            <p className="bch-hero__desc">
              {L(isUa, config.description, config.descriptionUk)}
            </p>
