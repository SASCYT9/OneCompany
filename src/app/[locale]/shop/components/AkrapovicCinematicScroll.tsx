...
export default function AkrapovicCinematicScroll({ isUa }: { isUa: boolean }) {
  ...
  const scenes = [
    ...
    },
    {
      ...
      subtitle: isUa
        ? "Ручне зварювання. Карбонові насадки. Створено інженерами."
        : "Hand-welded. Carbon fibre tips. Engineered by masters.",
            ...
            >
              ...
              {i === 0 && (
                <div className="mt-16 flex flex-col items-center gap-4 animate-bounce opacity-50">
                  <span className="text-xs tracking-widest uppercase font-mono text-white">
                    Scroll
                  </span>
