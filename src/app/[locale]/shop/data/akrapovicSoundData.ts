...
export const AKRAPOVIC_SOUNDS: SoundEntry[] = [
  ...
  },
  {
    ...
    make: 'Porsche',
    model: '911 GT3 (992)',
    image: '/images/shop/akrapovic/sound-porsche-911.jpg',
  ...
  },
  {
    ...
    image: '/images/shop/akrapovic/sound-mercedes-amg.jpg',
    exhaustType: 'Evolution Line (Titanium)',
    exhaustTypeUk: 'Evolution Line (Титан)',
  ...
  },
  {
    ...
    make: 'Audi',
    model: 'RS 6 Avant (C8)',
    image: '/images/shop/akrapovic/sound-audi-rs6.jpg',
  ...
  },
  {
    ...
    exhaustType: 'Slip-On Line (Titanium)',
    exhaustTypeUk: 'Slip-On Line (Титан)',
    soundUrl: '/sounds/akrapovic/ferrari-488.mp3',
    hpGain: '+9 HP',
