...
export const IPE_PRODUCT_LINES: IpeProductLine[] = [
  ...
  },
  {
    ...
    name: 'Ferrari',
    nameUk: 'Ferrari',
    description: '488, F8, Roma, SF90 — race-bred exhaust tuned to enhance the Italian V8 scream.',
    descriptionUk: '488, F8, Roma, SF90 — гоночний тюнінг для підсилення крику італійського V8.',
    badge: 'Supercar',
    badgeUk: 'Суперкар',
