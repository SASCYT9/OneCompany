...
export const ADRO_PRODUCT_LINES: AdroProductLine[] = [
  {
    ...
    badge: 'Flagship',
    badgeUk: 'Флагман',
    image: '/images/shop/adro/adro-hero-m4.jpg',
  ...
  },
  {
    ...
    badge: 'EV',
    badgeUk: 'EV',
    image: '/images/shop/adro/adro-hero-tesla.jpg',
  ...
  },
  {
    ...
    name: 'Porsche 718',
    nameUk: 'Porsche 718',
    description: 'Cayman & Boxster carbon kit — rear wing, front lip, side intakes for mid-engine balance.',
    descriptionUk: 'Карбоновий кіт Cayman & Boxster — заднє антикрило, спліттер, бокові повітрязабірники для середньомоторного балансу.',
    badge: 'Mid-Engine',
    badgeUk: 'Середній мотор',
    image: '/images/shop/adro/adro-hero-718.jpg',
    link: '/shop/adro/collections/porsche-718',
  },
  {
    id: 'bmw-m4-wide',
    name: 'BMW M4 Widebody',
    nameUk: 'BMW M4 Widebody',
    description: 'Complete wide-body conversion with extended fenders, aggressive splitter, and ducktail spoiler.',
    descriptionUk: 'Повна вайдбоді конверсія з розширеними крилами, агресивним спліттером та спойлером ducktail.',
    badge: 'Widebody',
    badgeUk: 'Вайдбоді',
    image: '/images/shop/adro/adro-m4-side.png',
    link: '/shop/adro/collections/bmw-m4-widebody',
  },
];
