      ...
      <div className="relative min-h-screen bg-black overflow-hidden flex flex-col pt-[100px]">
        <div className="w-full max-w-[1720px] mx-auto px-6 md:px-12 lg:px-16 pb-4">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/4 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.15em] text-white/50 transition-all hover:border-white/20 hover:bg-white/8 hover:text-white backdrop-blur-md shadow-[0_4px_12px_rgba(0,0,0,0.3)] relative z-50"
          >
        ...
        <section className="relative flex flex-1 flex-col items-center justify-center p-6 text-center">
          <div className="relative z-10 flex flex-col items-center -mt-20">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link
                href={`/${locale}/shop/urban/collections`}
                className="inline-flex min-h-12 items-center justify-center rounded-full border border-white/10 bg-white/4 px-8 text-xs font-semibold uppercase tracking-[0.15em] text-white transition duration-300 hover:border-white/25 hover:bg-white/10 backdrop-blur-md"
              >
                {isUa ? "Усі колекції" : "All collections"}
              </Link>
              <Link
                href={`/${locale}/shop/urban/products`}
                className="inline-flex min-h-12 items-center justify-center rounded-full bg-linear-to-br from-[#c29d59] to-[#a48245] px-8 text-xs font-semibold uppercase tracking-[0.15em] text-black transition duration-300 hover:from-[#ead29d] hover:to-[#c29d59]"
              >
