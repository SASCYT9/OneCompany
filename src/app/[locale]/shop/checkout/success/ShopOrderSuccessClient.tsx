  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl px-4 pb-20 pt-28 sm:px-6">
        <div className="rounded-[28px] border border-white/10 bg-white/5 p-8 text-center shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-10">
          <div
          ...
          <p className="text-[11px] uppercase tracking-[0.35em] text-white/45">One Company</p>
            ...
            (fopDetails.companyName || fopDetails.iban || fopDetails.details) && (
              <div className="mt-6 border-t border-white/10 pt-6 text-left">
                ...
                <div className="mt-3 space-y-1 text-sm text-white/80 font-mono">
                  ...
                  {fopDetails.details && (
                    <p className="mt-2 whitespace-pre-wrap text-white/70">{fopDetails.details}</p>
                  )}
                </div>
