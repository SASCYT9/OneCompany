...
export default async function GirodiscProductsCatalogPage({ params }: Props) {
  ...
  const girodiscProducts = products.filter(
    (p) => p.brand?.toLowerCase() === 'girodisc'
  );
    ...
    <div className="relative min-h-screen bg-[#030303] text-white overflow-hidden selection:bg-red-600 selection:text-white font-sans">
      ...
      <div className="relative z-10 pt-[140px] max-w-[1700px] mx-auto px-6 md:px-12 lg:px-16 pb-20">
        ...
        <div className="mb-4 relative z-50">
          <Link href={`/${resolvedLocale}/shop/girodisc`} className="text-[10px] tracking-[0.2em] uppercase text-zinc-500 hover:text-white transition-colors font-light flex items-center gap-2">
