...
const metaCopy: Record<SupportedLocale, { title: string; description: string }> = {
  en: {
    title: "Cookies Policy · onecompany",
    description: "Information about how we use cookies.",
  },
  ua: {
    title: "Політика Cookies · onecompany",
    description: "Інформація про використання файлів cookie.",
  },
};
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <div className="space-y-8 text-foreground dark:text-foreground/80 font-light">
          ...
          <section>
            ...
            <p>{l === "ua" ? "Ми використовуємо файли cookie для:" : "We use cookies to:"}</p>
            <ul className="list-disc pl-5 mt-4 space-y-2">
              <li>
                {l === "ua"
                  ? "Забезпечення коректної роботи веб-сайту (технічні cookie)."
                  : "Ensure the website functions correctly (technical cookies)."}
              </li>
              <li>
                {l === "ua"
                  ? "Збереження ваших налаштувань та вподобань (функціональні cookie)."
                  : "Save your settings and preferences (functional cookies)."}
              </li>
              <li>
                {l === "ua"
                  ? "Аналізу відвідуваності сайту для покращення користувацького досвіду (аналітичні cookie)."
                  : "Analyze site traffic to improve user experience (analytical cookies)."}
              </li>
            </ul>
          </section>
            ...
            <div className="space-y-4">
              <div>
                <strong className="text-foreground block mb-1">
                  {l === "ua" ? "Необхідні (Essential):" : "Essential:"}
                </strong>
                <p>
                  {l === "ua"
                    ? "Ці файли cookie є обов'язковими для роботи сайту і не можуть бути вимкнені в наших системах."
                    : "These cookies are necessary for the website to function and cannot be switched off in our systems."}
                </p>
              </div>
              <div>
                <strong className="text-foreground block mb-1">
                  {l === "ua" ? "Аналітичні (Analytics):" : "Analytics:"}
                </strong>
                <p>
                  {l === "ua"
                    ? "Дозволяють нам підраховувати відвідування та джерела трафіку, щоб ми могли вимірювати та покращувати продуктивність нашого сайту."
          ...
          <section>
            ...
            <div className="mt-4 not-prose border-l-2 border-primary pl-4">
              <p className="text-foreground font-medium">OneCompany</p>
