...
export default async function BrandsCategoryRacingPage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    { name: resolvedLocale === "ua" ? "Racing бренди" : "Racing brands", url: absoluteUrl(buildLocalizedPath(resolvedLocale, "/brands/racing")) },
  ];
  ...
  return (
    <div className="px-6 md:px-10 py-20 md:py-28">
      ...
      <CollectionPageSchema
        ...
        description={resolvedLocale === "ua" ? "Каталог racing брендів тюнінгу." : "Catalog of racing tuning brands."}
