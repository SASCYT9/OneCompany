  ...
  return (
    <div className="px-6 md:px-10 py-20 md:py-28">
      ...
      <CollectionPageSchema
        name={resolvedLocale === "ua" ? "OEM бренди" : "OEM brands"}
        description={
          resolvedLocale === "ua" ? "Каталог OEM брендів тюнінгу." : "Catalog of OEM tuning brands."
        }
        url={absoluteUrl(buildLocalizedPath(resolvedLocale, "/brands/oem"))}
      />
      ...
      <p className="max-w-3xl text-foreground/85 dark:text-foreground/70 text-lg mb-10 leading-relaxed">
        {resolvedLocale === "ua"
