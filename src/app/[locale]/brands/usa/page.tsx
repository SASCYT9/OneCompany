...
export default async function BrandsCategoryUSAPage({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    {
      name: resolvedLocale === "ua" ? "Бренди США" : "USA brands",
      url: absoluteUrl(buildLocalizedPath(resolvedLocale, "/brands/usa")),
    },
  ];
  ...
  return (
    <div className="px-6 md:px-10 py-20 md:py-28">
      ...
      <CollectionPageSchema
        ...
        description={
          resolvedLocale === "ua"
            ? "Каталог американських брендів тюнінгу."
            : "Catalog of US tuning brands."
        }
        url={absoluteUrl(buildLocalizedPath(resolvedLocale, "/brands/usa"))}
      />
