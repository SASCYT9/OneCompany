...
const metaCopy: Record<SupportedLocale, { title: string; description: string }> = {
  en: {
    title: "Privacy Policy · onecompany",
    description: "Our commitment to your privacy and data protection.",
  },
  ua: {
    title: "Політика конфіденційності · onecompany",
    description: "Наша політика конфіденційності та захисту даних.",
  },
};
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 pt-32 pb-16 text-foreground sm:px-6 lg:px-8">
      <div className="prose dark:prose-invert max-w-none">
        ...
        <div className="space-y-8 text-foreground dark:text-foreground/80 font-light">
          <section>
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2">
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "Особисті дані:" : "Personal Data:"}
                </strong>{" "}
                {l === "ua"
                  ? "Ім'я, адреса електронної пошти, номер телефону та назва компанії, які ви добровільно надаєте нам при реєстрації або заповненні форм."
                  : "Name, email address, phone number, and company name that you voluntarily give to us when you register or fill out forms."}
              </li>
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "Ділові дані:" : "Business Data:"}
                </strong>{" "}
                {l === "ua"
                  ? "Інформація про ваш бізнес, податковий номер, адреси доставки та платіжні реквізити для обробки замовлень."
                  : "Information about your business, tax ID, shipping addresses, and payment details for processing orders."}
              </li>
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "Технічні дані:" : "Technical Data:"}
                </strong>{" "}
                {l === "ua"
                  ? "IP-адреса, тип браузера, операційна система, час доступу та переглянуті сторінки."
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2">
              <li>
                {l === "ua"
                  ? "Обробки та виконання B2B замовлень та логістичних операцій."
                  : "Process and fulfill B2B orders and logistics operations."}
              </li>
              <li>
                {l === "ua"
                  ? "Надсилання вам підтверджень замовлень, інвойсів та оновлень статусу доставки."
                  : "Send you order confirmations, invoices, and shipping status updates."}
              </li>
              <li>
                {l === "ua"
                  ? "Надання технічної підтримки та консультацій щодо продуктів."
                  : "Provide technical support and product consultation."}
              </li>
              <li>
                {l === "ua"
                  ? "Повідомлення про оновлення асортименту, спеціальні пропозиції та новини індустрії."
                  : "Notify you of inventory updates, special offers, and industry news."}
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2">
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "Постачальникам послуг:" : "Service Providers:"}
                </strong>{" "}
                {l === "ua"
                  ? "Ми можемо ділитися вашою інформацією зі сторонніми постачальниками, які надають послуги нам або від нашого імені, включаючи обробку платежів, аналіз даних, доставку електронної пошти, хостинг, обслуговування клієнтів та логістику."
                  : "We may share your information with third-party vendors who perform services for us or on our behalf, including payment processing, data analysis, email delivery, hosting services, customer service, and logistics."}
              </li>
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "За вимогами закону:" : "By Law or to Protect Rights:"}
                </strong>{" "}
                {l === "ua"
                  ? "Якщо ми вважаємо, що розкриття інформації про вас є необхідним для реагування на судовий процес, розслідування або усунення потенційних порушень нашої політики, або для захисту прав, власності та безпеки інших осіб."
          ...
          <section>
            ...
            <div className="mt-4 not-prose border-l-2 border-primary pl-4">
              <p className="text-foreground font-medium">One Company</p>
