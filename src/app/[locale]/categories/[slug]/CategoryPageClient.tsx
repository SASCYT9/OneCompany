  ...
  return (
    <div className="bg-black text-white min-h-screen">
      <header className="container mx-auto px-6 py-24 text-center">
        ...
        <p className="text-lg text-white/70 font-light max-w-3xl mx-auto text-pretty">
          {description}
        </p>
      </header>
      ...
      <main className="container mx-auto px-6 pb-24">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
          {category.brands.map((brand) => (
            <div
              key={brand}
              className="p-6 bg-white/2 border border-white/10 backdrop-blur-3xl rounded-2xl text-center shadow-[0_20px_40px_rgba(0,0,0,0.4)] hover:scale-[1.02] transition-transform duration-500"
            >
        ...
        <div className="text-center mt-16">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full border border-white/30 px-8 py-3 text-sm uppercase tracking-wide text-white transition hover:border-white hover:bg-white hover:text-black"
          >
