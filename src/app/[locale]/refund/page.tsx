...
const metaCopy: Record<SupportedLocale, { title: string; description: string }> = {
  ...
  ua: { title: "Повернення коштів · onecompany", description: "Політика повернення коштів та обміну товарів." },
};
        ...
        <div className="space-y-8 text-white/80 font-light">
          ...
          <section>
            <h2 className="text-xl font-normal text-white mb-4 mt-8">
              {l === "ua" ? "1. Право на повернення товарів належної якості" : "1. Right to Return Good Quality Items"}
            </h2>
            <p>
              {l === "ua"
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2">
              ...
              <li>{l === "ua" ? "Збережено товарний вигляд, споживчі властивості, пломби, ярлики." : "Original condition, consumer properties, seals, and tags are preserved."}</li>
              <li>{l === "ua" ? "Є розрахунковий документ (чек, квитанція)." : "A receipt or proof of purchase is present."}</li>
            </ul>
          </section>
