              ...
              <div className="relative flex flex-col gap-3 sm:gap-4 flex-1">
                ...
                <div className="mt-2 flex flex-wrap gap-1.5 text-[10px] uppercase tracking-[0.25em] text-white/50 sm:mt-4 sm:gap-2 sm:text-[11px] sm:tracking-[0.3em]">
                  {cat.brands.slice(0, 4).map((name) => (
                    <span key={name} className="rounded-full border border-emerald-500/20 bg-emerald-500/5 px-2.5 py-0.5 text-white/80 hover:border-emerald-500/40 hover:bg-emerald-500/10 transition-colors sm:px-3 sm:py-1">
                      {name}
                    </span>
                  ))}
                  {cat.brands.length > 4 && (
                    <span className="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 text-emerald-300/70 sm:px-3 sm:py-1">
