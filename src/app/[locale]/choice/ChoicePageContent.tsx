...
const allBrands = [
  ...
  { name: "Defi", logo: "/logos/defi.png", category: "Tuning", popular: true },
  {
    ...
    logo: "/logos/innovate-motorsports.png",
    category: "Tuning",
    popular: true,
  },
...
function PanelBackdrop({
  ...
  return (
    <>
      ...
      {/* accent when active */}
      <div
        className={`absolute inset-0 bg-linear-to-br ${accent} opacity-0 ${active ? "opacity-100" : ""} transition-opacity duration-700 mix-blend-soft-light`}
      />
      {/* divider */}
