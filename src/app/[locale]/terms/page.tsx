...
const metaCopy: Record<SupportedLocale, { title: string; description: string }> = {
  en: {
    title: "Terms of Service · onecompany",
    description: "Terms governing the use of our services and site.",
  },
  ua: {
    title: "Умови надання послуг · onecompany",
    description: "Умови користування нашим сайтом та послугами.",
  },
};
            ...
            <ul className="list-disc pl-5 mt-4 space-y-2">
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "Розміщення замовлень:" : "Order Placement:"}
                </strong>{" "}
                {l === "ua"
                  ? "Замовлення приймаються через наших менеджерів або офіційні канали зв'язку. Всі замовлення підлягають підтвердженню наявності та ціни."
                  : "Orders are accepted through our account managers or official communication channels. All orders are subject to availability and price confirmation."}
              </li>
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "Ціноутворення:" : "Pricing:"}
                </strong>{" "}
                {l === "ua"
                  ? "Ціни вказані в доларах США або Євро, якщо не зазначено інше. Ми залишаємо за собою право змінювати ціни без попереднього повідомлення у разі зміни курсів валют або цін виробників."
                  : "Prices are quoted in USD or EUR unless otherwise stated. We reserve the right to change prices without notice due to currency fluctuations or manufacturer price changes."}
              </li>
              <li>
                <strong className="text-foreground">
                  {l === "ua" ? "Умови оплати:" : "Payment Terms:"}
                </strong>{" "}
                {l === "ua"
                  ? "Оплата здійснюється згідно з виставленим інвойсом. Для спеціальних замовлень може вимагатися передоплата."
                  : "Payment is due as per the issued invoice. Prepayment may be required for special orders."}
              </li>
            </ul>
          </section>
