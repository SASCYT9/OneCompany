    ...
    <div className="relative h-full w-full overflow-auto bg-black text-white p-6 md:p-10">
      ...
      <div className="max-w-6xl mx-auto">
        <Link
          ...
          className="group mb-10 inline-flex items-center gap-2 text-[13px] font-medium tracking-wide text-white/40 hover:text-white transition-all"
        >
          ...
          <div className="flex-1 space-y-8">
            <div>
              ...
              <p className="text-zinc-500 text-sm max-w-md leading-relaxed">
                Розрахунок фінальної вартості товару з урахуванням логістики, ваги та цільової
                маржі.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Price & Currency */}
              <div className="space-y-4 p-6 rounded-none bg-white/2 border border-white/5 backdrop-blur-xl">
                <label className="block text-[10px] uppercase tracking-widest text-zinc-500 font-bold">
                  Вхідна ціна (Dealer Cost)
                </label>
                <div className="flex gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-black/40 border border-white/10 rounded-none text-xl font-light focus:outline-hidden focus:border-blue-500/50 transition-all"
                    />
                  </div>
                  <select
                    value={currency}
                    onChange={(e) => setCurrency(e.target.value as any)}
                    className="px-4 py-3 bg-black/40 border border-white/10 rounded-none text-sm font-bold focus:outline-hidden focus:border-blue-500/50"
                  >
              ...
              <div className="space-y-4 p-6 rounded-none bg-white/2 border border-white/5 backdrop-blur-xl">
                <label className="block text-[10px] uppercase tracking-widest text-zinc-500 font-bold">
                  Зона доставки (Target Zone)
                </label>
                <select
                  value={zone}
                  onChange={(e) => setZone(e.target.value as ShippingZone)}
                  className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-none text-sm font-bold focus:outline-hidden focus:border-blue-500/50"
                >
              ...
              <div className="space-y-4 p-6 rounded-none bg-white/2 border border-white/5 backdrop-blur-xl">
                <label className="block text-[10px] uppercase tracking-widest text-zinc-500 font-bold flex justify-between">
                  Вага (Actual Weight)
                  <span className="text-zinc-400 font-mono text-[11px] normal-case tracking-tight">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-4 pr-12 py-3 bg-black/40 border border-white/10 rounded-none text-xl font-light focus:outline-hidden focus:border-blue-500/50"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4 p-6 rounded-none bg-white/2 border border-white/5 backdrop-blur-xl">
                <label className="block text-[10px] uppercase tracking-widest text-zinc-500 font-bold flex justify-between">
                  Габарити (Dimensions)
                  <span className="text-amber-400 font-mono text-[11px] normal-case tracking-tight">
                    Vol: {shipping.volWeightKg.toFixed(2)} kg
                  </span>
                </label>
                <div className="grid grid-cols-3 gap-2">
                  <div className="relative">
                    <input
                      ...
                      placeholder="L"
                      className="w-full px-3 py-2 bg-black/40 border border-white/10 rounded-none text-center text-sm focus:outline-hidden focus:border-amber-500/50"
                    />
                    <span className="absolute -top-1.5 left-2 bg-black px-1 text-[8px] text-zinc-600 font-bold">
                      L
                    </span>
                  </div>
                  <div className="relative">
            ...
            {/* Markup Slider */}
            <div className="p-8 rounded-none-[40px] bg-linear-to-br from-blue-500/10 to-transparent border border-blue-500/20">
              <div className="flex justify-between items-end mb-6">
                <div>
                  <label className="block text-[10px] uppercase tracking-[0.2em] text-zinc-400 font-bold mb-2">
                    Цільова Націнка
                  </label>
                  <div className="text-5xl font-light text-white">
                    {markup}
                    <span className="text-2xl text-zinc-400/50 ml-1">%</span>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-xl font-mono text-zinc-500">
                    ×{(1 + markup / 100).toFixed(2)}
                  </div>
                </div>
              </div>
              <input
              ...
              >
                <div className="p-8 border-b border-white/5 bg-white/2">
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xl text-zinc-600 font-mono">
                      .{(retailPrice % 1).toFixed(2).split(".")[1]}
                    </span>
                  </div>
                </div>
                ...
                <div className="p-8 space-y-6">
                  ...
                  <div className="bg-emerald-500/5 rounded-none p-5 border border-emerald-500/10">
                    <div className="flex justify-between items-end mb-2">
                      <div className="text-[10px] uppercase tracking-widest text-emerald-500/70 font-bold">
                        Очікуваний Прибуток
                      </div>
                  ...
                  {shipping.volWeightKg > shipping.actualWeightKg && (
                    <div className="p-4 rounded-none bg-amber-500/5 border border-amber-500/10 flex gap-3 items-start">
                      ...
                      <p className="text-[10px] text-amber-500/80 leading-relaxed uppercase font-medium">
                        Увага: Об&apos;ємна вага ({shipping.volWeightKg.toFixed(1)}kg) перевищує
                        фактичну ({shipping.actualWeightKg.toFixed(1)}kg). Вартість доставки
                        збільшена.
                      </p>
                    </div>
                  )}
