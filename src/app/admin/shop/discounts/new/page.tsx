      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px]">
        <div className="space-y-5">
          ...
          <AdminInspectorCard
            ...
            description="Customer-facing code and internal description."
          >
            <div className="grid gap-4 md:grid-cols-2">
              <div className="flex items-end gap-2">
                ...
                <button
                  ...
                  className="rounded-none border border-white/10 bg-white/3 p-2 text-zinc-400 transition hover:bg-white/6 hover:text-blue-300"
          ...
          <AdminInspectorCard
            title="Discount type"
            description="Choose how the discount works. Conditions adapt to the selection."
          >
            <div className="grid gap-4 md:grid-cols-2">
              <AdminSelectField
                label="Type"
            ...
            {type === "BUY_X_GET_Y" ? (
              <div className="mt-4 space-y-4">
                <div className="rounded-none border border-blue-500/20 bg-blue-500/5 p-3 text-xs text-blue-200">
                  Customer must buy <b>{buyQty || "X"}</b> items, then gets <b>{getQty || "Y"}</b>{" "}
                  items at <b>{getDiscountPct || "100"}% off</b>. The cheapest items will receive
                  the discount.
                </div>
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  />
                  <AdminInputField
                    label="Discount on Get %"
                    value={getDiscountPct}
                    onChange={setGetDiscountPct}
                    type="number"
                    min={0}
                    max={100}
                  />
          ...
          {/* Conditions */}
          <AdminInspectorCard
            title="Conditions & eligibility"
            description="Restrict who, when and how often the code can be used."
          >
            <div className="grid gap-4 md:grid-cols-2">
              <AdminInputField
            ...
            <div className="mt-5">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <AdminCheckboxField
                  label="B2B pending"
                  checked={b2bPendingAllowed}
                  onChange={setB2bPendingAllowed}
                />
                <AdminCheckboxField
                  label="B2B approved"
                  checked={b2bApprovedAllowed}
                  onChange={setB2bApprovedAllowed}
                />
              </div>
            </div>
          </AdminInspectorCard>
          ...
          <AdminInspectorCard
            ...
            description="Optional start and end dates. Leave blank for always-on."
          >
            <div className="grid gap-4 md:grid-cols-2">
              <AdminInputField
                label="Valid from"
        ...
        <aside className="space-y-4">
          <AdminInspectorCard
            title="Save"
            description="Drafts are not redeemable. Activate when ready."
          >
            <button
              type="button"
          ...
          <AdminInspectorCard title="Preview" description="How customers see this code.">
            <div className="rounded-none border border-blue-500/25 bg-blue-500/6 p-4">
