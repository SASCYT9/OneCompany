  ...
  return (
    <div className="relative min-h-screen bg-[#030303] text-white p-6 md:p-10 font-sans overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-zinc-100 text-black/10 rounded-none-full blur-[150px] mix-blend-screen" />
        <div className="absolute bottom-0 left-1/4 w-[800px] h-[800px] bg-emerald-600/5 rounded-none-full blur-[150px] mix-blend-screen" />
      </div>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
           ...
           <div className="relative group overflow-hidden rounded-none border border-white/[0.08] bg-black/40 backdrop-blur-xl p-6 transition-all hover:border-amber-500/30 hover:bg-black/60">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 to-transparent pointer-events-none" />
              <div className="relative flex items-center justify-between mb-4">
                <div className="w-10 h-10 rounded-none bg-amber-500/10 border border-amber-500/20 flex items-center justify-center">
                  <Percent className="w-5 h-5 text-amber-500" />
                </div>
                <div className="bg-amber-500/10 text-amber-500 text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-none">Глобально</div>
              </div>
           ...
           {/* Card 2: Total Brands */}
           <div className="relative group overflow-hidden rounded-none border border-white/[0.08] bg-black/40 backdrop-blur-xl p-6 transition-all hover:border-indigo-500/30 hover:bg-black/60">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-transparent pointer-events-none" />
              <div className="relative flex items-center justify-between mb-4">
                <div className="w-10 h-10 rounded-none bg-zinc-100 text-black/10 border border-indigo-500/20 flex items-center justify-center">
           ...
           <div className="relative group overflow-hidden rounded-none border border-white/[0.08] bg-black/40 backdrop-blur-xl p-6 transition-all hover:border-rose-500/30 hover:bg-black/60">
              <div className="absolute inset-0 bg-gradient-to-br from-rose-500/5 to-transparent pointer-events-none" />
              <div className="relative flex items-center justify-between mb-4">
                <div className="w-10 h-10 rounded-none bg-rose-500/10 border border-rose-500/20 flex items-center justify-center">
           ...
           <div className="relative group overflow-hidden rounded-none border border-white/[0.08] bg-black/40 backdrop-blur-xl p-6 transition-all hover:border-emerald-500/30 hover:bg-black/60">
              ...
              <div className="relative flex items-center justify-between mb-4">
                ...
                <div className="bg-emerald-500/10 text-emerald-500 text-[10px] font-bold uppercase tracking-widest px-2 py-1 rounded-none">Прогноз</div>
              </div>
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4 mb-6">
          <div className="flex-1 flex items-center border border-white/10 bg-white/[0.03] rounded-none px-5 h-14 backdrop-blur-md focus-within:border-indigo-500/50 focus-within:bg-zinc-100 text-black/5 transition-all">
          ...
          <button
            ...
            className={`flex items-center justify-center gap-3 px-6 h-14 rounded-none border text-sm font-semibold uppercase tracking-widest transition-all ${
              showOnlyCustom
          ...
          <button
            ...
            className="flex items-center justify-center gap-3 px-6 h-14 rounded-none border border-white/10 bg-white/[0.03] text-zinc-400 hover:text-white hover:bg-white/5 text-sm font-semibold uppercase tracking-widest transition-all"
          >
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-32">
            <div className="w-12 h-12 rounded-none-full border-2 border-zinc-800 border-t-indigo-500 animate-spin mb-6 shadow-[0_0_20px_rgba(99,102,241,0.4)]"></div>
            <p className="text-zinc-500 uppercase tracking-widest text-sm font-bold animate-pulse">Зчитування даних з Turn14...</p>
          </div>
        ) : (
          <div className="rounded-none border border-white/[0.08] bg-black/40 backdrop-blur-2xl overflow-hidden shadow-2xl relative">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="col-span-12 md:col-span-4 flex items-center gap-4">
                        <div className="w-10 h-10 rounded-none-full bg-white/[0.05] border border-white/10 flex items-center justify-center text-xs font-bold text-zinc-400 uppercase">
                          {brand.name.substring(0,2)}
                        </div>
                        <div>
                          <div className="text-base font-medium text-zinc-200 tracking-wide flex items-center gap-2">
                            {brand.name}
                            {isEdited && <div className="w-2 h-2 rounded-none-full bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.8)]" title="Unsaved changes" />}
                          </div>
                      ...
                      <div className="col-span-12 md:col-span-4 flex items-center gap-4">
                        <input
                          ...
                          className="flex-1 h-2 appearance-none bg-zinc-800 rounded-none-full cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-white [&::-webkit-slider-thumb]:rounded-none-full hover:[&::-webkit-slider-thumb]:scale-125 transition-all"
                          style={{
                        ...
                        <div className="relative">
                          <input
                            ...
                            value={markup}
                            onChange={(e) => handleMarkupChange(brand.id, Number(e.target.value))}
                            className="w-16 bg-black border border-white/10 rounded-none px-2 py-2 text-white text-center text-sm font-semibold focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 transition-all font-mono"
                          />
                      ...
                      <div className="col-span-6 md:col-span-2 flex items-center justify-end">
                        {isCustom ? (
                          <div className="inline-flex flex-col items-end">
                            <span className="text-[10px] uppercase tracking-widest font-bold text-amber-500 border border-amber-500/30 bg-amber-500/10 px-3 py-1.5 rounded-none shadow-[0_0_10px_rgba(245,158,11,0.1)]">
                              Унікальна
                            </span>
                          </div>
                        ) : (
                          <span className="text-[10px] uppercase tracking-widest font-bold text-zinc-500 border border-zinc-800 bg-zinc-900/50 px-3 py-1.5 rounded-none">
                            Global
                          </span>
                        )}
                      </div>
