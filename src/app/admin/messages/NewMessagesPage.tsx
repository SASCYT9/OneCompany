...
export default function NewMessagesPage() {
  ...
  return (
    <div className="h-screen bg-zinc-900 text-white flex flex-col">
      ...
      {/* Stats */}
      <div className="grid grid-cols-4 gap-4 p-6 bg-zinc-900">
        ...
        <div className="bg-zinc-950 rounded-xl p-4 border border-zinc-800">
          <div className="text-zinc-400 text-sm mb-1">Read</div>
          <div className="text-3xl font-bold text-purple-400">{stats.read}</div>
        </div>
        <div className="bg-zinc-950 rounded-xl p-4 border border-zinc-800">
          <div className="text-zinc-400 text-sm mb-1">Replied</div>
      ...
      <div className="flex-1 grid grid-cols-[400px_1fr] gap-6 p-6 overflow-hidden">
        {/* Messages List */}
        <div className="bg-zinc-950 rounded-xl border border-zinc-800 flex flex-col">
              ...
              <div className="p-6 border-b border-zinc-800">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h2 className="text-2xl font-semibold mb-2">{selectedMessage.userName}</h2>
              ...
              <div className="p-6 border-t border-zinc-800">
                ...
                <div className="mt-3 flex justify-end">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-2.5 bg-white text-black rounded-lg font-medium hover:bg-zinc-200 disabled:opacity-50 disabled:cursor-not-allowed transition"
                  >
