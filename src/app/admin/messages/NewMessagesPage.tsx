          ...
          <div className="p-3 border-b border-white/10 flex-none space-y-3 bg-black/50 backdrop-blur-sm">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-zinc-900/50 border border-white/10 rounded-none focus:outline-none focus:border-white/20 text-sm placeholder:text-zinc-600 transition-colors"
              />
            </div>
              ...
              <div className="flex-none p-6 border-t border-white/10 bg-black">
                <div className="relative group">
                  <textarea
                    ...
                    className="w-full p-4 pr-16 bg-zinc-900/30 border border-white/10 rounded-none focus:outline-none focus:border-white/20 focus:bg-zinc-900/50 resize-none text-base min-h-[120px] transition-all placeholder:text-zinc-700"
                  />
                  <button
                    onClick={sendReply}
