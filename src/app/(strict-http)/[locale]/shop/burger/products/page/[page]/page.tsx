...
import renderBurgerProductsCatalogPage, { generateMetadata as generateBaseMetadata } from "@/app/[locale]/shop/burger/products/page";
type Props = {
  params: Promise<{ locale: string; page: string }>;
};
const BASE_SLUG = "shop/burger/products";
...
export default async function PagedCatalog({ params }: Props) {
  ...
  if (!page) notFound();
  if (page === 1) permanentRedirect(`/${locale}/${BASE_SLUG}`);
  return renderBurgerProductsCatalogPage({ params: Promise.resolve({ locale }) }, page);
}
