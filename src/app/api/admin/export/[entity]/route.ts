...
const VALID_ENTITIES: readonly ExportEntity[] = [
  "orders",
  "customers",
  "products",
  "inventory",
...
const EXPORT_PERMISSIONS: Readonly<Record<ExportEntity, AdminPermission>> = {
  orders: ADMIN_PERMISSIONS.SHOP_ORDERS_READ,
  customers: ADMIN_PERMISSIONS.SHOP_CUSTOMERS_READ,
  products: ADMIN_PERMISSIONS.SHOP_PRODUCTS_READ,
  inventory: ADMIN_PERMISSIONS.SHOP_INVENTORY_READ,
};
...
export async function GET(
  ...
  try {
    ...
    await assertAdminRequest(cookieStore, EXPORT_PERMISSIONS[entity as ExportEntity]);
