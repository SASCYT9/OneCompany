...
export default async function TelegramAppPage() {
  ...
  const normalizedSiteUrl = (
    process.env.NEXT_PUBLIC_SITE_URL || "https://onecompany.global"
  ).replace(/\/$/, "");
    ...
    <>
      ...
      <main className="relative isolate min-h-screen overflow-hidden bg-[#04050a] pb-16 pt-10 text-white">
        <div className="pointer-events-none absolute inset-0 opacity-80">
          <div className="absolute -left-24 top-0 h-72 w-72 rounded-full bg-[radial-gradient(circle,rgba(255,179,71,0.25),transparent_65%)] blur-[140px]" />
          <div className="absolute right-0 top-40 h-64 w-64 rounded-full bg-[radial-gradient(circle,rgba(92,188,255,0.25),transparent_60%)] blur-[120px]" />
        </div>
        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-10 px-4 sm:px-6 lg:px-8">
          <section className="glass-panel gradient-border rounded-[38px] border border-white/10 p-6 sm:p-10">
            <p className="text-[11px] uppercase tracking-[0.55em] text-white/45">
              Telegram mini app · onecompany
            </p>
          ...
          <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <span className="text-[11px] uppercase tracking-[0.45em] text-white/40">
                          {action.badge}
                        </span>
            ...
            <div className="glass-panel rounded-[32px] border border-white/10 p-6 sm:p-8">
              ...
              <div className="mt-6 rounded-3xl border border-white/10 bg-linear-to-r from-white/10 to-transparent p-4">
          ...
          <section className="grid gap-6 lg:grid-cols-2">
            {successStories.map((story) => (
              ...
              >
                <div className="flex items-center justify-between gap-4">
                  <span className="text-[11px] uppercase tracking-[0.45em] text-white/45">
                    {story.badge}
                  </span>
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-semibold text-white">
                  Залишіть бриф або продовжіть у Telegram
                </h2>
                <p className="mt-3 text-sm text-white/60">
                  Підготуйте VIN, список бажаних брендів та дедлайни. Ми зберемо пропозицію,
                  оновлення статусу та доставку в один чат.
                </p>
