...
const LINE_LABELS: Record<string, LineMeta> = {
  ...
  "slip-on-race": {
    display: "Slip-On Race Line",
    concept: "задня частина (Slip-On / Axleback), трек-орієнтована",
  },
  evolution: { display: "Evolution Line", concept: "Cat-Back — середня + задня частина" },
  racing: { display: "Racing Line", concept: "вихлопна система серії Racing" },
  "header-ti": { display: "Optional Header (Titanium)", concept: "титановий випускний колектор" },
  "header-ss": { display: "Optional Header (SS)", concept: "колектор із нержавіючої сталі" },
  header: { display: "Optional Header", concept: "випускний колектор" },
  "heat-shield": { display: "Carbon Heat Shield", concept: "карбоновий теплозахисний екран" },
  "muffler-bracket": { display: "Muffler Bracket", concept: "кронштейн кріплення глушника" },
  "noise-damper": { display: "Noise Damper", concept: "шумоглушник (вставка-флейта)" },
  "protection-bars": { display: "Protection Bars", concept: "комплект титанових захисних дуг" },
  footpegs: { display: "Footpegs", concept: "комплект туристичних підніжок" },
  downpipe: { display: "Downpipe", concept: "секція від турбіни / випускного колектора" },
  "link-pipe": {
    display: "Evolution Link Pipe",
    concept: "з'єднувальна секція між каталізатором і задньою частиною",
  },
  ...
  "sound-kit": {
    display: "Sound & Control Kit",
    concept: "електронний модуль керування заслінками",
  },
...
const FAMILY_DESCRIPTIONS: Record<string, string> = {
  ...
  racing:
    "Racing Line — вихлопна система Akrapovič із колекторами з нержавіючої сталі та титановим глушником.",
  "header-ti":
    "Optional Header (Titanium) — опціональний випускний колектор Akrapovič, повністю виготовлений із високоякісного титану для максимального зниження ваги та покращення звуку.",
  "header-ss":
    "Optional Header (SS) — опціональний випускний колектор Akrapovič із високоякісної нержавіючої сталі для збільшення потужності та опіру відведення газів.",
  header:
    "Optional Header — опціональний випускний колектор Akrapovič для покращення продуктивності та надання глибшого спортивного звуку.",
  "heat-shield":
    "Carbon Heat Shield — термозахисний екран Akrapovič із вуглецевого волокна (карбону). Захищає деталі від нагріву та додає преміального зовнішнього вигляду.",
  "muffler-bracket":
    "Muffler Bracket — кронштейн кріплення глушника Akrapovič. Дозволяє надійно зафіксувати глушник при демонтажі пасажирських підніжок.",
  "noise-damper":
    "Noise Damper — знімний вставний шумоглушник (dB-killer / флейта) Akrapovič для зниження рівня гучності вихлопної системи.",
  "protection-bars":
    "Protection Bars — комплект посилених захисних дуг Akrapovič із високоміцного титану для надійного захисту мотоцикла в екстремальних умовах.",
  footpegs:
    "Footpegs Set — комплект посилених титанових туристичних підніжок Akrapovič для покращеного зчеплення та впевненого контролю під час їзди стоячи.",
  downpipe:
...
export function buildAkrapovicEditorialCopy(
  input: AkrapovicEditorialInput
): AkrapovicEditorialCopy {
  ...
  const titleUa = vehicle ? `${titleHead} — Akrapovič для ${vehicle}` : `${titleHead} — Akrapovič`;
