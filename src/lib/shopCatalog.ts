...
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  {
    slug: 'akrapovic-slip-on-bmw-m',
    sku: 'OC-AKR-BMWM-SLIP',
    scope: 'auto',
    brand: 'Akrapovic',
    title: { ua: 'Akrapovic Slip-On BMW M', en: 'Akrapovic Slip-On BMW M' },
    category: { ua: 'Вихлоп', en: 'Exhaust' },
    shortDescription: {
      ua: 'Титановий slip-on з фірмовим тоном і меншою вагою.',
      en: 'Titanium slip-on with signature tone and reduced weight.',
    },
    longDescription: {
      ua: 'Система створена для BMW M-платформ із фокусом на звук, відгук і преміальний finish. Дає помітний приріст характеру без втрати щоденного комфорту.',
      en: 'Built for BMW M platforms with focus on tone, response, and premium finish. Delivers a clear personality upgrade without compromising daily usability.',
    },
    leadTime: { ua: '5-8 днів', en: '5-8 days' },
    stock: 'inStock',
    collection: { ua: 'Signature Sound', en: 'Signature Sound' },
    price: { eur: 2290, usd: 2470, uah: 97400 },
    image: '/images/shop/products/akrapovic-slip-on-bmw-m.png',
    gallery: ['/images/shop/products/akrapovic-slip-on-bmw-m.png'],
    highlights: [
      { ua: 'Легкий титановий корпус', en: 'Titanium body' },
      { ua: 'OEM-сумісність по геометрії', en: 'OEM geometry compatibility' },
