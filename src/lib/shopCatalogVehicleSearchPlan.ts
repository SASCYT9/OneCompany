...
export function buildShopCatalogVehicleSearchPlan(params: URLSearchParams) {
  ...
  const canonical = Boolean(constraints.engine || constraints.fuel);
  return { constraints, canonical };
}
