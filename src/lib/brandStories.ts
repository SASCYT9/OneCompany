...
function pickCuratedBrandStory(
  brandName: string,
...
function getSubcategoryTagline(
...
function getSubcategoryHighlights(
  subcategory: ProductSubcategory | undefined
): { en: string; ua: string }[] {
  const bySubcategory: Partial<Record<ProductSubcategory, { en: string; ua: string }[]>> = {
    Exhaust: [
...
function buildDefaultDescription(
  ...
  const contextEn =
    context === "Moto" ? "motorcycle" : context === "Auto" ? "automotive" : "performance";
...
export function getBrandStoryForBrand(
  brand: BrandStoryInput,
  context?: BrandStoryContext
): BrandStory {
  ...
  const fallbackDescription = buildDefaultDescription(
    brand.name,
    subcategory,
    meta?.country,
    context
...
export const curatedBrandStories: Record<string, BrandStory> = {
  ...
  Akrapovic_Auto: {
    headline: {
      en: "Akrapovic · The Sound of Performance",
      ua: "Akrapovic · Звук чистої потужності",
    },
    description: {
  ...
  Akrapovic_Moto: {
    headline: {
      en: "Akrapovic · The Sound of Performance",
      ua: "Akrapovic · Еталон звуку та потужності",
    },
    description: {
  ...
  "HRE Wheels": {
    headline: {
      en: "HRE · The World's Best Custom Forged Wheels",
      ua: "HRE · Найкращі у світі ковані диски",
    },
    description: {
  ...
  Novitec: {
    headline: {
      en: "Novitec · Refinement for Supercars",
      ua: "Novitec · Вишуканість для суперкарів",
    },
    description: {
  ...
  Vorsteiner: {
    ...
    highlights: [
      ...
      {
        en: "Fitment guidance for clean installs",
        ua: "Поради по встановленню для чистого результату",
      },
    ],
  },
  Armytrix: {
    ...
    highlights: [
      ...
      {
        en: "Valve control designed to integrate cleanly",
        ua: "Керування клапанами для коректної інтеграції",
      },
  ...
  Velos: {
    ...
    highlights: [
      {
        en: "24-26 inch fitments verified for Maybach & Cullinan",
        ua: '24-26" підбори для Maybach та Cullinan',
      },
  ...
  Weistec: {
    headline: {
      en: "Weistec Engineering Power Lab",
      ua: "Weistec Engineering — лабораторія потужності",
    },
    description: {
    ...
    highlights: [
      ...
      {
        en: "Built transmissions with break-in support",
        ua: "Підготовлені КПП з підтримкою обкатки",
      },
  ...
  TECHART: {
    ...
    highlights: [
      ...
      {
        en: "Unique carbon body kits, forged wheels and more",
        ua: "Унікальні карбонові обвіси, ковані диски і не тільки",
      },
    ],
  },
};
