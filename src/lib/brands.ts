...
export const brandsUsa: LocalBrand[] = [
  { name: '1221 wheels', website: 'https://1221wheels.com' },
  { name: '1016 Industries' },
  { name: '5150 Autosport' },
  { name: 'AE Design' },
  { name: 'ADV.1 wheels', website: 'https://www.adv1wheels.com' },
  { name: 'Agency Power' },
  { name: 'Airlift Performance', website: 'https://www.airliftperformance.com' },
  { name: 'AL13 wheels', website: 'https://al13wheels.com' },
  ...
  { name: 'Borla' },
  { name: 'Brixton wheels' },
  { name: 'Burger Motorsport', website: 'https://burgertuning.com' },
  { name: 'Circle D' },
  { name: 'Cobb tuning' },
  { name: 'CMST' },
  { name: 'CSF', website: 'https://csfrace.com' },
  { name: 'DarwinPro' },
  { name: 'Deatschwerks' },
  ...
  { name: 'Fabspeed', website: 'https://www.fabspeed.com' },
  { name: 'Fall-Line Motorsports' },
  { name: 'Fore Innovations' },
  { name: 'Fragola Performance Systems' },
  { name: 'Full-Race' },
  { name: 'Future Design' },
  { name: 'Girodisc', website: 'https://girodisc.com' },
  { name: 'HRE wheels', website: 'https://www.hrewheels.com' },
  ...
  { name: 'Mountune', website: 'https://www.mountune.com' },
  { name: 'MV Forged', website: 'https://mvforged.com' },
  { name: 'Paragon brakes', website: 'https://paragonbrakes.com' },
  { name: 'Premier Tuning Group' },
  { name: 'Project 6GR' },
  { name: 'Pure Drivetrain Solutions' },
  { name: 'Pure Turbos', website: 'https://www.pureturbos.com' },
  { name: 'Renntech', website: 'https://www.renntechmercedes.com' },
  { name: 'RK Autowerks' },
  { name: 'RPM Transmissions' },
  { name: 'RKP' },
  { name: 'RYFT', website: 'https://ryft.co' },
  { name: 'Seibon' },
  { name: 'ShepTrans' },
  { name: 'Southern Hotrod' },
  { name: 'Spool Performance' },
  { name: 'SPL Parts', website: 'https://www.splparts.com' },
  { name: 'Strasse wheels', website: 'https://strassewheels.com' },
  { name: 'Stoptech', website: 'https://www.apcautotech.com/brands/stoptech' },
  { name: 'Stillen' },
  { name: 'Titan Motorsport' },
  { name: 'TireRack' },
  { name: 'Turner Motorsport' },
  { name: 'Vargas Turbo', website: 'https://vargasturbo.com' },
  { name: 'Velos Wheels', website: 'https://velosdesignwerks.com' },
  { name: 'VF Engineering', website: 'https://vfengineering.com' },
  { name: 'VP Racing Fuel' },
  { name: 'VR Aero' },
  { name: 'VR Bespoke' },
  { name: 'VR Forged' },
  { name: 'VR Performance' },
  { name: 'Vorsteiner', website: 'https://vorsteiner.com' },
  { name: 'Wavetrac' },
  { name: 'Weistec Engineering', website: 'https://www.weistec.com' },
...
export const brandsEurope: LocalBrand[] = [
  { name: '3D Design' },
  { name: 'ABT', website: 'https://www.abt-sportsline.com' },
  { name: 'AC Schnitzer' },
  { name: 'ADRO' },
  { name: 'Akrapovic', website: 'https://www.akrapovic.com' },
  { name: 'Alpha-N', website: 'https://alpha-n.de' },
  { name: 'ARMA Speed', website: 'https://www.armaspeed.com' },
  { name: 'Armytrix', website: 'https://www.armytrix.com' },
  { name: 'Black Boost' },
  { name: 'BMC', website: 'https://www.bmcairfilters.com' },
  { name: 'Brabus' },
  { name: 'Brembo', website: 'https://www.brembo.com' },
  { name: 'BC Racing', website: 'https://www.bcracing-na.com' },
  { name: 'Capristo', website: 'https://capristo.de' },
  { name: 'CT Carbon' },
  { name: 'Custom Cages' },
  { name: 'Dahler' },
  { name: 'DMC' },
  { name: 'do88', website: 'https://www.do88.se' },
  { name: 'DTE Systems' },
  { name: 'ESS Tuning' },
  { name: 'Eventuri', website: 'https://www.eventuri.net' },
  { name: 'FI Exhaust', website: 'https://www.fi-exhaust.com' },
  { name: 'GTHaus' },
  { name: 'Gruppe-M', website: 'https://www.gruppem.co.jp/en' },
  { name: 'Hamann' },
  { name: 'Hardrace', website: 'https://www.hardrace.com' },
  { name: 'Harrop' },
  { name: 'IPe exhaust' },
  { name: 'ItalianRP' },
  { name: 'KAHN design' },
  { name: 'Karbonius', website: 'https://karbonius.net' },
  { name: 'Keyvany', website: 'https://keyvany.com' },
  { name: 'Kline Innovation' },
  { name: 'KW Suspension', website: 'https://www.kwsuspensions.com' },
  { name: 'Lamspeed' },
  { name: 'Larte Design', website: 'https://larte-design.com' },
  { name: 'Liberty Walk', website: 'https://libertywalk.co.jp' },
  { name: 'LOBA Motorsport' },
  { name: 'Lorinser' },
  { name: 'Lumma', website: 'https://www.lumma-design.com' },
  { name: 'Manhart', website: 'https://manhart-performance.de' },
  { name: 'Mansory' },
  { name: 'Mamba turbo' },
  { name: "Matts Carbon" },
  { name: 'Milltek' },
  { name: 'MST Performance', website: 'https://www.mst-performance.com' },
  { name: 'Novitec' },
  { name: 'Nitron Suspension', website: 'https://www.nitron.co.uk' },
  { name: 'Onyx Concept' },
  { name: 'Pagid' },
  { name: 'Power Division' },
  ...
  { name: 'Remus' },
  { name: 'Renegade Design', website: 'https://renegade-design.com' },
  { name: 'RES Exhaust' },
  { name: 'Ronin Design' },
  { name: 'RS-R', website: 'https://www.rs-r.com' },
  { name: 'RW Carbon' },
  { name: 'Sachs Performance', website: 'https://www.sachsperformance.com' },
  { name: 'Schrick' },
  { name: 'Sterckenn' },
  { name: 'STOPART ceramic', website: 'http://www.stopartcn.com' },
  { name: 'Supersprint', website: 'https://www.supersprint.com' },
  { name: 'Tubi Style', website: 'https://www.tubistyle.it' },
  { name: 'TTE Turbos' },
  { name: 'TTH turbos' },
  { name: 'Urban Automotive' },
  { name: 'Wagner Tuning', website: 'https://www.wagner-tuning.com' },
  { name: 'WALD' },
  { name: 'WheelForce' },
  { name: 'xHP' },
  { name: 'Zacoe' },
  { name: 'Bride', website: 'https://bride-jp.com/en/' },
  { name: 'Corbeau', website: 'https://corbeau.com' },
  { name: 'OMP', website: 'https://www.ompracing.com' },
  { name: 'Takata', website: 'https://www.takataracing.com' },
  { name: 'Schroth', website: 'https://www.schrothracing.com' },
  { name: 'Sabelt', website: 'https://www.sabelt.com' },
];
...
export const brandsRacing: LocalBrand[] = [
  { name: 'AIM Sportline' },
  { name: 'ARE dry sump' },
  { name: 'Bell Intercoolers', website: 'https://bellintercoolers.com' },
  ...
  { name: 'MCA Suspension', website: 'https://mcasuspension.com' },
...
export const brandMetadata: Record<string, BrandMetadata> = {
  ...
  'Bride': { country: 'Japan', subcategory: 'Interior' },
  'Corbeau': { country: 'UK', subcategory: 'Interior' },
  'OMP': { country: 'Italy', subcategory: 'Interior' },
  'Takata': { country: 'Japan', subcategory: 'Interior' },
  'Schroth': { country: 'Germany', subcategory: 'Interior' },
  'Sabelt': { country: 'Italy', subcategory: 'Interior' },
