...
export const brandsUsa: LocalBrand[] = [
  ...
  { name: 'aFe Power', description: 'California-based performance air intake, exhaust, and power-package specialists serving the truck, SUV, and sport-compact aftermarket since 1999 with dyno-validated horsepower gains.', descriptionUA: 'Каліфорнійський спеціаліст з продуктивних впусків, вихлопу та пакетів потужності для пікапів, SUV та sport-compact аутофтермаркету з 1999 року, з підтвердженим діно приростом потужності.', website: 'https://afepower.com' },
  { name: 'K&N', description: 'Iconic American performance air filter brand since 1969 — washable cotton-gauze filters, cold-air intake systems, and oil filters trusted by enthusiasts worldwide.', descriptionUA: 'Легендарний американський бренд продуктивних повітряних фільтрів з 1969 року — миючі бавовняно-сітчасті фільтри, системи холодного впуску та масляні фільтри, яким довіряють ентузіасти по всьому світу.', website: 'https://www.knfilters.com' },
  ...
  { name: 'ANRKY Wheels', description: 'Bold forged wheel designs featuring deep concave faces and aggressive fitments, engineered for the modern performance enthusiast.', descriptionUA: 'Сміливі ковані дизайни дисків з глибокими увігнутими поверхнями та агресивними посадками, розроблені для сучасного ентузіаста продуктивності.', website: 'https://anrky.com' },
  ...
  { name: 'Avant Garde Wheels', slug: 'avantgarde-wheels', description: 'Fashion-forward forged wheel designs that push creative boundaries, offering unique finishes and custom specifications for discerning enthusiasts.', descriptionUA: 'Передові дизайни кованих дисків, що розширюють творчі межі, пропонуючи унікальні покриття та індивідуальні специфікації для вимогливих ентузіастів.', website: 'https://www.avantgardewheels.com' },
  ...
  { name: 'Driveshaftshop', description: 'American driveshaft and CV axle specialists crafting steel, aluminum, and carbon fiber driveshafts for sport compact, European, and modern muscle applications.', descriptionUA: 'Американські спеціалісти з карданних валів та ШРУС: вали зі сталі, алюмінію та карбону для sport compact, європейських та сучасних мускл-каров.', website: 'https://www.driveshaftshop.com' },
  ...
  { name: 'G-Sport by GESi', description: 'Industry-leading high-performance catalytic converters featuring proprietary S-Wound metallic substrates and advanced precious metal coatings, supporting up to 1,200 HP per converter with EPA compliance.', descriptionUA: 'Преміальні спортивні каталізатори американського виробництва з фірмовою технологією S-Wound, що забезпечують максимальний потік вихлопу без втрати потужності — до 1 200 к.с. на конвертер.', website: 'https://www.gsportbygesi.com' },
  ...
  { name: 'Lingenfelter', description: 'Legendary American performance engineering since 1973, delivering supercharger systems, turnkey engine packages, and Corvette/Camaro performance upgrades that set industry benchmarks.', descriptionUA: 'Легендарна американська performance-інженерія з 1973 року, компресорні системи, turnkey-збірки двигунів та апгрейди Corvette/Camaro, що встановлюють галузеві стандарти.', website: 'https://www.lingenfelter.com' },
  ...
  { name: 'Velos Designwerks', slug: 'velos-wheels', description: 'Bespoke forged wheels handcrafted to exact specifications, combining engineering excellence with artistic design vision.', descriptionUA: 'Ексклюзивні ковані диски ручної роботи за точними специфікаціями, поєднуючи інженерну досконалість з художнім баченням дизайну.', website: 'https://velosdesignwerks.com' },
...
export const brandsEurope: LocalBrand[] = [
  ...
  { name: 'Alcon', description: 'British carbon-ceramic and steel brake-system manufacturer founded in 1984, supplying premium calipers and discs for OEM (Aston Martin, Porsche), motorsport (WRC, NASCAR), and aftermarket performance applications.', descriptionUA: 'Британський виробник карбон-керамічних та сталевих гальмівних систем (засн. 1984), преміальні супорти та диски для OEM (Aston Martin, Porsche), автоспорту (WRC, NASCAR) та aftermarket performance.', website: 'https://www.alcon.co.uk' },
  ...
  { name: 'ap Sportfahrwerke', description: 'German suspension brand offering affordable, high-quality lowering springs and coilovers for price-performance focused automotive enthusiasts.', descriptionUA: 'Німецький бренд підвісок зі співвідношенням ціна-якість, доступні спортивні пружини та койловери високої якості для ентузіастів.', website: 'https://store.kwautomotive.de/de-en/brands/ap-sportfahrwerke' },
  ...
  { name: 'BBS', description: 'Legendary German wheel manufacturer known for their iconic multi-piece designs and extensive motorsport heritage, setting the standard for performance wheels.', descriptionUA: 'Легендарний німецький виробник дисків, відомий своїми культовими багатоскладовими дизайнами та багатою гоночною спадщиною, що встановлює стандарт індустрії.', website: 'https://www.bbs.com/en/home' },
  ...
  { name: 'dbilas dynamic', description: 'German engine tuning specialists providing high-performance camshafts, intake systems, and complete engine upgrades.', descriptionUA: 'Німецькі спеціалісти з тюнінгу двигунів, що пропонують високопродуктивні розподільні вали, впускні системи та комплексні покращення.', website: 'https://dbilas.com' },
  ...
  { name: 'LEIB Engineering', description: 'German plug-and-play automotive electronics specialist creating CAN bus modules, OPF/GPF delete solutions, valve controls, and MIL deleters for modern BMW performance platforms.', descriptionUA: 'Німецький спеціаліст з автомобільної електроніки plug-and-play: CAN BUS модулі, OPF/GPF delete рішення, керування клапанами та MIL deleter для сучасних платформ BMW.', website: 'https://www.leib-engineering.de/Homepage_1' },
  ...
  { name: 'MapEV', description: 'Software and electromobility tuning specialists providing advanced performance calibration for electric vehicles.', descriptionUA: 'Спеціалісти з тюнінгу програмного забезпечення та електромобільності, що забезпечують передове калібрування продуктивності для електромобілів.', website: 'https://www.mapev.net' },
  ...
  { name: 'Matts Performance', slug: 'matts-carbon', description: 'Polish carbon fiber craftsmen creating premium aerodynamic components with motorsport-derived quality and precision.', descriptionUA: 'Польські майстри карбону, що створюють преміальні аеродинамічні компоненти з гоночною якістю та точністю.', website: 'https://mattscarbon.com' },
  ...
  { name: 'Mishimoto', description: 'World leader in performance cooling products since 2005 — aluminum radiators, intercoolers, oil coolers, and silicone hoses engineered for street and track applications.', descriptionUA: 'Світовий лідер у performance-охолодженні з 2005 року — алюмінієві радіатори, інтеркулери, маслорадіатори та силіконові патрубки для дороги та треку.', website: 'https://www.mishimoto.com' },
  ...
  { name: 'MTS Technik', description: 'Polish suspension manufacturer specializing in coilovers, lowering springs, and performance dampers for European platforms.', descriptionUA: 'Польський виробник підвіски, койловери, пружини заниження та продуктивні амортизатори для європейських платформ.', website: 'https://mtstechnik.com/en/' },
  ...
  { name: 'Oettinger', description: 'German VAG tuning specialist developing performance upgrades, software calibrations, aerodynamic components, and complete styling packages for Volkswagen, Audi, SEAT, and Skoda.', descriptionUA: 'Німецький спеціаліст з тюнінгу VAG: апгрейди продуктивності, програмні калібрування, аеродинамічні компоненти та комплексні стайлінг-пакети для Volkswagen, Audi, SEAT і Skoda.', website: 'https://www.oettinger.de/' },
  ...
  { name: 'Reiger Suspension', description: 'Dutch motorsport suspension specialists crafting championship-winning shock absorbers for rally, WRC, Dakar, and off-road applications.', descriptionUA: 'Нідерландські спеціалісти з гоночних підвісок, що створюють чемпіонські амортизатори для ралі, WRC, Дакар та позашляховиків.', website: 'https://www.reigersuspension.com/de-en' },
  { name: 'Renegade Design', description: 'Internationally renowned luxury tuning studio specializing in aggressive wide-body conversions and premium carbon fiber aerodynamic packages for Mercedes G-Class, Rolls-Royce, Lamborghini Urus, and other elite platforms.', descriptionUA: 'Всесвітньо відоме тюнінг-ательє, що спеціалізується на агресивних вайдбоді конверсіях та преміальних карбонових аеродинамічних пакетах для Mercedes G-Class, Rolls-Royce, Lamborghini Urus та інших елітних платформ.', website: 'https://renegade-design.net' },
  { name: 'RES Exhaust', description: 'Chinese performance exhaust manufacturer (since 2000) producing titanium-alloy and stainless steel systems for Ferrari, Lamborghini, BMW, Porsche, and Nissan platforms.', descriptionUA: 'Китайський виробник продуктивних вихлопних систем (з 2000 року), титанові та нержавіючі системи для Ferrari, Lamborghini, BMW, Porsche та Nissan.', website: 'https://www.res-exhaust.com' },
  { name: 'Red Star Exhaust', description: 'Performance exhaust specialists crafting valvetronic and titanium systems for sports cars and motorcycles, with racing-spec downpipes and slip-on options.', descriptionUA: 'Спеціалісти з продуктивних вихлопних систем, вальветронік та титанові системи для спорткарів і мотоциклів, racing-spec даунпайпи та slip-on опції.', website: 'https://redstar-exhaust.com' },
  { name: 'Ronin Design', description: 'Italian luxury tuning atelier from Reggio Emilia crafting bespoke carbon fiber body kits and aerodynamic components for premium European platforms.', descriptionUA: 'Італійське розкішне тюнінг-ательє з Реджо-Емілії, ексклюзивні карбонові бодікіти та аеродинамічні компоненти для преміальних європейських платформ.', website: 'https://www.ronindesign.eu' },
  ...
  { name: 'SCL Concept', description: 'Carbon fiber body styling specialists creating wide-body kits and aerodynamic components for luxury performance vehicles.', descriptionUA: 'Спеціалісти з карбонового стайлінгу кузова, вайдбоді кіти та аеродинамічні компоненти для розкішних спорткарів.', website: 'https://www.sclconcept.com' },
  { name: 'SooQoo', description: 'Premium pre-preg carbon fiber automotive styling specialists crafting front splitters, side skirts, rear diffusers, and trim pieces for BMW M, Mercedes-AMG, and other high-performance platforms.', descriptionUA: 'Преміальні фахівці з пре-прег карбонового стайлінгу — передні спойлери, накладки на пороги, задні дифузори та трим-елементи для BMW M, Mercedes-AMG та інших спортивних платформ.', website: 'https://www.sooqoocarbon.com' },
  { name: 'ST suspensions', description: 'German suspension manufacturer offering high-quality coilovers, sport springs, and wheel spacers engineered by KW automotive.', descriptionUA: 'Німецький виробник підвісок, що пропонує високоякісні койловери, спортивні пружини та колісні проставки, які розроблені KW automotive.', website: 'https://store.kwautomotive.de/de-en/brands/st-suspensions' },
  ...
  { name: 'TECHART', description: 'German Porsche tuning house delivering signature body kits, interiors, and performance upgrades with OEM-level integration.', descriptionUA: 'Німецьке тюнінг-ательє Porsche, фірмові бодікіти, інтер’єри та апгрейди продуктивності з інтеграцією рівня OEM.', website: 'https://www.techart.de/en.html' },
  { name: 'TopCar Design', description: 'World-class luxury vehicle tuning atelier crafting bespoke carbon fiber body kits, exclusive interiors, and complete visual transformations for Lamborghini, Porsche, Mercedes-AMG, and other prestige marques.', descriptionUA: 'Тюнінг-ательє світового класу, що створює ексклюзивні карбонові бодікіти, унікальні інтер’єри та повні візуальні трансформації для Lamborghini, Porsche, Mercedes-AMG та інших престижних марок.', website: 'https://topcardesign.com' },
  { name: 'TTE Turbos', description: 'German turbo engineering specialists (The Turbo Engineers) crafting upgraded turbochargers and complete turbo kits for VW Group, BMW, and Audi performance applications.', descriptionUA: 'Німецькі спеціалісти з турбо-інженерії (The Turbo Engineers), оновлені турбіни та комплектні турбо-кіти для VW Group, BMW та Audi.', website: 'https://www.tte-performance.com' },
  ...
  { name: 'VPX TrackWheels', description: 'German wheel engineering focused on track-ready flow-formed designs, combining low rotational mass, motorsport durability, and clean modern styling for enthusiast builds.', descriptionUA: 'Німецька інженерія дисків із фокусом на трек: легкі flow-formed дизайни, поєднання малої обертової маси, гоночної витривалості та сучасного мінімалістичного стилю для проєктів ентузіастів.', website: 'https://vpx-trackwheels.de' },
...
export const brandsRacing: LocalBrand[] = [
  ...
  { name: 'Extreme Performance Tyres', slug: 'extreme-tyres', description: 'High-performance slick and compound tires engineered specifically for track-day enthusiasts and amateur racing competition.', descriptionUA: 'Високопродуктивні слік-шини, розроблені спеціально для трек-дей ентузіастів та аматорських гоночних змагань.', website: 'https://extreme-tyres.com' },
...
export const brandsMoto: LocalBrand[] = [
  ...
  { name: 'Moto Corse', description: 'Premium Italian CNC machined accessories and titanium exhausts for MV Agusta, Ducati, and BMW.', descriptionUA: 'Преміальні італійські фрезеровані аксесуари (CNC) та титанові вихлопні системи для MV Agusta, Ducati та BMW.', website: 'https://www.motocorsestore.com/it/' },
