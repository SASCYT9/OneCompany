...
export const brandsUsa: LocalBrand[] = [
  ...
  { name: 'Deatschwerks', description: 'Precision fuel system components engineered for high-horsepower builds, from injectors to complete fuel delivery solutions.', descriptionUA: 'Прецизійні компоненти паливної системи для потужних збірок, від форсунок до комплексних рішень подачі палива.', website: 'https://www.deatschwerks.com' },
...
export const brandsEurope: LocalBrand[] = [
  ...
  { name: 'Deikin', description: 'Russian exhaust system manufacturer creating performance solutions with distinctive sound character for European performance vehicles.', descriptionUA: 'Російський виробник вихлопних систем, рішення продуктивності з характерним звуком для європейських спортивних автомобілів.', website: 'https://deikin.ru' },
  ...
  { name: 'Red Star Exhaust', description: 'Russian exhaust system manufacturer creating performance solutions with aggressive sound character for European sports cars.', descriptionUA: 'Російський виробник вихлопних систем, рішення продуктивності з агресивним звуком для європейських спортивних авто.', website: 'https://redstarexhaust.com' },
  ...
  { name: 'Renegade Design', description: 'Russian aerodynamic design studio creating bold body kits and carbon fiber components for luxury SUVs and supercars.', descriptionUA: 'Російська студія аеродинамічного дизайну, сміливі бодікіти та карбонові компоненти для розкішних SUV та суперкарів.', website: 'https://renegade-design.com' },
  { name: 'Ronin Design', description: 'Russian automotive design studio specializing in aggressive wide-body kits and aerodynamic packages for luxury vehicles.', descriptionUA: 'Російська студія автомобільного дизайну, спеціалізація на агресивних широких кузовах та аеродинамічних пакетах для розкішних авто.', website: 'https://ronindesign.ru' },
  { name: 'RES Exhaust', description: 'Chinese exhaust system manufacturer producing quality performance systems with valvetronic technology at competitive pricing.', descriptionUA: 'Китайський виробник вихлопних систем, якісні системи продуктивності з вальветронною технологією за конкурентними цінами.', website: 'https://www.resexhaust.com' },
  ...
  { name: 'SCL Concept', description: 'Russian automotive design studio creating exclusive body kits and aerodynamic packages for premium luxury vehicles.', descriptionUA: 'Російська студія автомобільного дизайну, ексклюзивні бодікіти та аеродинамічні пакети для преміальних розкішних авто.', website: 'https://scl-concept.ru' },
  { name: 'SooQoo', description: 'Chinese carbon fiber specialists producing affordable aerodynamic components with quality construction and fitment.', descriptionUA: 'Китайські спеціалісти з карбону, доступні аеродинамічні компоненти з якісною конструкцією та посадкою.', website: 'https://www.sooqoo.com' },
  ...
  { name: 'TopCar Design', description: 'Russian luxury tuning house creating comprehensive transformation packages for Porsche, Lamborghini, and Mercedes-Benz.', descriptionUA: 'Російський розкішний тюнінг-ательє, комплексні пакети трансформації для Porsche, Lamborghini та Mercedes-Benz.', website: 'https://topcardesign.com' },
  ...
  { name: 'TTE Turbos', description: 'German turbocharger specialists engineering premium upgrade units that deliver substantial power gains with proven reliability.', descriptionUA: 'Німецькі спеціалісти з турбін, преміальні апгрейди, що забезпечують суттєвий приріст потужності з перевіреною надійністю.', website: 'https://www.theturboengineers.com' },
  ...
  { name: 'Urban Automotive', description: 'British luxury vehicle specialists creating premium carbon fiber components and comprehensive packages for Range Rover and Mercedes.', descriptionUA: 'Британські спеціалісти розкішних авто, преміальні карбонові компоненти та комплексні пакети для Range Rover та Mercedes.', website: 'https://www.urbanautomotive.co.uk' },
...
export const brandMetadata: Record<string, BrandMetadata> = {
  ...
  'Deikin': { country: 'Russia', subcategory: 'Exhaust' },
  ...
  'Red Star Exhaust': { country: 'Russia', subcategory: 'Exhaust' },
  'Remus': { country: 'Austria', subcategory: 'Exhaust' },
  'Renegade Design': { country: 'Russia', subcategory: 'Aero' },
  'Ronin Design': { country: 'Russia', subcategory: 'Aero' },
  ...
  'SCL Concept': { country: 'Russia', subcategory: 'Aero' },
  'SooQoo': { country: 'China', subcategory: 'Exterior' },
  'Sterckenn': { country: 'Poland', subcategory: 'Exterior' },
  ...
  'TopCar Design': { country: 'Russia', subcategory: 'Aero' },
