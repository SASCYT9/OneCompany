...
const titles = [
  {
    ...
    streakColor: "rgba(255, 255, 255, 0.7)",
  },
  {
    text: "KW Suspension",
    gradient: "from-orange-500 to-red-600",
    streakColor: "rgba(255, 107, 53, 0.7)",
  },
  {
    text: "Fi Exhaust",
    gradient: "from-cyan-400 to-blue-600",
    streakColor: "rgba(79, 195, 247, 0.7)",
  },
  {
    text: "Eventuri",
    gradient: "from-purple-500 to-pink-600",
    streakColor: "rgba(194, 79, 199, 0.7)",
  },
];
  ...
  return (
    <div className="relative">
      ...
      {showEffects && !isAnimating && (
        <>
          <LightStreak color={currentTitle.streakColor} duration={2.5} delay={0} />
          <LightBurst
            interval={8}
            colors={
              currentSlide === 1
      ...
      <h1
        className={`
          ...
          ${isAnimating ? "opacity-0 scale-95 blur-xs" : "opacity-100 scale-100 blur-0"}
        `}
      >
        <span
          className={`
            bg-linear-to-r ${currentTitle.gradient} 
