    ...
    >
      ...
      <div className="relative overflow-hidden rounded-lg border border-white/10 bg-black/20 backdrop-blur-md p-8 transition-all duration-500 hover:border-white/30 hover:bg-white/5">
        ...
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
          <div className="absolute inset-[-2px] bg-linear-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-lg blur-xs -z-10" />
        </div>

        {/* Category badge */}
        {category && (
          <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-white/10 backdrop-blur-xs border border-white/20">
        ...
        {/* Description */}
        {description && (
          <p className="text-sm font-thin text-white/60 line-clamp-2 mb-4">{description}</p>
        )}
