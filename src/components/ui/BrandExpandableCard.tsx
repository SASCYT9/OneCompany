  ...
  return (
    <>
      <motion.button
        ...
        className="group relative w-full p-6 rounded-xl bg-[linear-gradient(160deg,var(--surface-1),var(--surface-2))] border border-white/10 hover:border-white/20 transition-all duration-300 text-left focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white/40"
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <div className="mt-3 text-sm font-light text-white/80 group-hover:text-white transition-colors">
            {name}
          </div>
          <div className="text-[9px] tracking-wider uppercase text-white/30 mt-1">
            {categoryLabel}
          </div>
        </div>
        {/* subtle shine */}
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(800px 200px at 50% -20%, rgba(255,255,255,0.08), transparent 70%)",
          }}
        />
        <div
        ...
        {open && (
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background: "linear-gradient(165deg, rgba(24,26,30,0.92), rgba(14,16,20,0.92))",
              }}
            >
              <div className="p-8">
                ...
                <div className="mt-8 flex items-center gap-3">
                  <button
                    className="cta-primary text-xs tracking-wider uppercase font-medium focus:outline-hidden focus-visible:ring-2 focus-visible:ring-white/40"
                    onClick={() => setOpen(false)}
                  >
                    Close
                  </button>
