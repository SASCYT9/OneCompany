  ...
  const sections = [
    {
      ...
      description:
        "Precision engineered coilovers that redefine your driving experience. German engineering meets motorsport performance.",
    ...
    },
    {
      ...
      description:
        "Unleash the true voice of your engine. Valvetronic technology for the ultimate sound experience.",
      features: [
        "Valvetronic Control",
    ...
    },
    {
      ...
      description:
        "The art of airflow. Carbon fiber intake systems engineered through computational fluid dynamics.",
    ...
    <div className="fixed inset-0 z-45 pointer-events-none">
      <div className="w-screen h-screen relative">
        {sections.map((section, idx) => (
          <Section key={idx} {...section} index={idx} scrollProgress={scrollProgress} />
        ))}
      </div>
    </div>
  );
