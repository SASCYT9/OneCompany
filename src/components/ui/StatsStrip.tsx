    ...
    <div className="relative container mx-auto px-6 mt-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {items.map((it, i) => (
          <div
            key={i}
            className="group relative overflow-hidden bg-linear-to-br from-white/8 via-white/4 to-white/2 rounded-2xl p-6 backdrop-blur-xs shadow-lg"
          >
            <div className="absolute inset-0 bg-linear-to-br from-orange-500/0 via-rose-500/0 to-transparent group-hover:from-orange-500/5 group-hover:via-rose-500/3 transition-all duration-700" />
            ...
            <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-linear-to-r from-transparent via-white/0 to-transparent group-hover:via-white/30 transition-all duration-700" />
          </div>
        ))}
      </div>
    </div>
