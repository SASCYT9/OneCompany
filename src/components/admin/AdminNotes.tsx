            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-1.5 text-[11px]">
                  ...
                  {n.isPinned ? (
                    <span className="rounded-full border border-amber-500/30 bg-amber-500/[0.08] px-1.5 py-0 text-[9px] font-bold uppercase tracking-wider text-amber-300">
                      Закріплено
                    </span>
                  ) : null}
                </div>
              ...
              <div className="mt-1.5 whitespace-pre-wrap text-sm leading-6 text-zinc-200">{n.content}</div>
              <div className="mt-1.5 text-[10px] text-zinc-500" title={new Date(n.createdAt).toLocaleString()}>
