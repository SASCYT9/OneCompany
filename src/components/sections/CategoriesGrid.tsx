    ...
    <section ref={sectionRef} className="relative py-32 px-6 bg-black overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold mb-4 bg-linear-to-r from-white to-zinc-400 bg-clip-text text-transparent">
            {title}
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((category, index) => (
            <Link
              ...
              className="group relative p-8 rounded-2xl border border-white/10 bg-zinc-950/50 backdrop-blur-xs hover:border-white/20 transition-all duration-500 overflow-hidden"
            >
