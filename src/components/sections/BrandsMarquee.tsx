...
export default function BrandsMarquee() {
  ...
  return (
    <section className="relative py-24 bg-zinc-950 overflow-hidden border-y border-white/5">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-linear-to-r from-black via-transparent to-black pointer-events-none z-10" />

      <div className="container mx-auto mb-12 px-6">
        <h2 className="text-3xl md:text-5xl font-bold text-center bg-linear-to-r from-white to-zinc-400 bg-clip-text text-transparent">
      ...
      {/* Scrolling marquee */}
      <div ref={marqueeRef} className="flex gap-16 items-center will-change-transform">
