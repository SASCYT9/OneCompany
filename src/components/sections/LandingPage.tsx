...
const LandingPage = () => {
  ...
  return (
    <>
      {/* Hero Section - Full-Screen Video Background. Forced .dark scope:
          the video itself is dark and fills the viewport, so the overlaid text
          should always read as light regardless of the active site theme. */}
      <section
        ref={heroRef}
        className="dark relative w-full h-screen overflow-hidden bg-background text-foreground"
      >
        {/* Video Background */}
        <video
          autoPlay
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <div className="fade-in flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
              <MagneticButton>
                <Link
                  href="/auto"
                  className="group text-2xl md:text-4xl text-foreground/90 hover:text-white font-light tracking-wider uppercase transition-all duration-500"
                >
              ...
              <div className="text-foreground/40 text-2xl md:text-4xl font-thin">|</div>
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection delay={0.2}>
            <div className="text-center mb-24">
              ...
              <div className="w-32 h-px bg-zinc-300 dark:bg-foreground/20 mx-auto mb-16" />
              <p className="text-xl md:text-2xl text-zinc-600 dark:text-foreground/60 leading-relaxed max-w-5xl mx-auto font-light">
                {t("welcomeText")}
              </p>
            </div>
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.3}>
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
              {["PERFORMANCE", "QUALITY", "SERVICE", "SOUND", "INNOVATION"].map((value, index) => (
                <AnimatedCard
                  key={index}
                  ...
                  hoverScale={1.02}
                >
                  <p className="text-sm font-light uppercase tracking-[0.2em] text-zinc-700 dark:text-foreground/70">
                    {value}
                  </p>
                </AnimatedCard>
              ))}
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection delay={0.2}>
            <div className="text-center mb-24">
              ...
              <div className="w-32 h-px bg-zinc-300 dark:bg-foreground/20 mx-auto" />
            </div>
          </AnimatedSection>
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <AnimatedSection delay={0.3}>
              <AnimatedCard className="bg-white dark:bg-zinc-900/30 p-12 hover:shadow-2xl dark:hover:bg-zinc-900/50 transition-all duration-500 h-full">
                <div className="mb-8">
                  <div className="w-16 h-16 flex items-center justify-center border border-zinc-200 dark:border-foreground/10">
                    <span className="text-3xl font-extralight text-zinc-900 dark:text-white">
                      01
                    </span>
                  </div>
                </div>
                <h3 className="text-2xl font-light text-zinc-900 dark:text-white mb-6 tracking-wide">
                  Expert Selection
                </h3>
                <p className="text-zinc-600 dark:text-foreground/50 text-base leading-relaxed font-light">
            ...
            <AnimatedSection delay={0.4}>
              <AnimatedCard className="bg-white dark:bg-zinc-900/30 p-12 hover:shadow-2xl dark:hover:bg-zinc-900/50 transition-all duration-500 h-full">
                ...
                <p className="text-zinc-600 dark:text-foreground/50 text-base leading-relaxed font-light">
                  Access to certified installation partners worldwide, ensuring professional fitment
                  and optimal performance of all components.
                </p>
              </AnimatedCard>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.5}>
              <AnimatedCard className="bg-white dark:bg-zinc-900/30 p-12 hover:shadow-2xl dark:hover:bg-zinc-900/50 transition-all duration-500 h-full">
                ...
                <p className="text-zinc-600 dark:text-foreground/50 text-base leading-relaxed font-light">
                  Comprehensive after-sales support and technical assistance to ensure complete
        ...
        <div className="max-w-7xl mx-auto">
          <AnimatedSection delay={0.2}>
            <div className="text-center mb-24">
              ...
              <div className="w-32 h-px bg-zinc-300 dark:bg-foreground/20 mx-auto mb-10" />
              <p className="text-zinc-600 dark:text-foreground/50 max-w-3xl mx-auto text-lg font-light">
                We represent over 200+ world-leading brands in performance automotive and motorcycle
                parts
              </p>
            </div>
          </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              >
                <h3 className="text-xl font-light text-zinc-900 dark:text-white mb-4 tracking-wide group-hover:text-zinc-700 dark:hover:text-foreground/90 transition-colors">
                  {category.name}
                </h3>
                <p className="text-zinc-500 dark:text-foreground/40 text-sm leading-relaxed font-light">
                  {category.desc}
                </p>
              </div>
            ))}
      ...
      <section className="bg-white dark:bg-black py-40 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="w-32 h-px bg-zinc-300 dark:bg-foreground/20 mx-auto mb-16" />
          <p className="text-zinc-600 dark:text-foreground/50 text-xl md:text-2xl mb-16 max-w-3xl mx-auto leading-relaxed font-light">
            Contact our specialists for personalized recommendations and expert advice on premium
            performance parts
          </p>
