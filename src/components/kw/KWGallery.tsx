...
export function KWGallery() {
  ...
  return (
    <section className="relative py-24 px-6 bg-linear-to-b from-black via-slate-900/30 to-black">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Stats */}
        <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 p-8 bg-linear-to-r from-slate-800/30 to-slate-900/30 rounded-2xl border border-white/10">
      ...
      {selectedImage !== null && (
        ...
        >
          <div className="max-w-6xl w-full">
            ...
            <div className="text-center">
              <h3 className="text-3xl font-bold text-white mb-2">{gallery[selectedImage].title}</h3>
