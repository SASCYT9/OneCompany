...
export function AnimatedLogo({
  ...
  return (
    <div ref={logoRef} className={`relative ${className}`}>
      ...
      {enableStreak && (
        <>
          <LightStreak color="rgba(255, 107, 53, 0.6)" duration={2.5} delay={0} />
          <LightStreak color="rgba(79, 195, 247, 0.6)" duration={3} delay={1.5} />
          <LightStreak color="rgba(194, 79, 199, 0.6)" duration={2.8} delay={3} />
        </>
      )}
