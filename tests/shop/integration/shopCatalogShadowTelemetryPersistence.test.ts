...
test(
  "shadow aggregates retain concurrent samples, mismatches, errors, and segments",
  { skip: !databaseUrl },
  async () => {
    ...
    try {
      const {
        recordShopCatalogShadowObservationWithClient,
        readShopCatalogShadowEvidenceWithClient,
